...
#
# Generated by export_simulation on Fri Jun 12 17:49:13 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './Key.sh' script.
...
./Key.sh -noclean_files

For more information on the script, please type './Key.sh -help'.
